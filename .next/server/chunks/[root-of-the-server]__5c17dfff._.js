...
"[project]/.next-internal/server/app/api/summary/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$upstash$2b$qstash$40$2$2e$7$2e$23$2f$node_modules$2f40$upstash$2f$qstash$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@upstash+qstash@2.7.23/node_modules/@upstash/qstash/index.mjs [app-route] (ecmascript) <module evaluation>");
...
const qstashClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$upstash$2b$qstash$40$2$2e$7$2e$23$2f$node_modules$2f40$upstash$2f$qstash$2f$chunk$2d$G7CVCBTL$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Client"]({
    ...
    try {
        ...
        try {
            ...
            if (isLocalhost) {
                ...
                qstashDestination = destinationUrl.replace(/https?:\/\/(localhost|127\.0\.0\.1|\:\:1)(:\d+)?/, ngrokUrl);
...
async function PUT(request) {
    try {
        ...
        // Check if destination is a localhost URL
        const isLocalhost = destination.includes("localhost") || destination.includes("127.0.0.1") || destination.includes("::1");
        // Use ngrok tunnel for local development
        const ngrokUrl = "https://eaa8-201-244-238-219.ngrok-free.app";
        if (isLocalhost) {
            // For local development, use ngrok tunnel instead of localhost
            console.log("Using ngrok tunnel for local development");
            // Replace localhost URL with ngrok URL
            const ngrokDestination = destination.replace(/https?:\/\/(localhost|127\.0\.0\.1|\:\:1)(:\d+)?/, ngrokUrl);
...
async function GET(request) {
    try {
        ...
        if (id) {
            ...
            const summary = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].summary.findUnique({
                where: {
                    id
                }
            });
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(summary);
        } else {
            // Get all summaries
            const summaries = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].summary.findMany({
                orderBy: {
                    createdAt: "desc"
                }
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(summaries);
        }
    } catch (error) {
...
async function DELETE(request) {
    try {
        ...
        // Delete the summary
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].summary.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5c17dfff._.js.map